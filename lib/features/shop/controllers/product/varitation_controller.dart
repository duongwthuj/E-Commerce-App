...
class VariationController extends GetxController {
  ...
  void onAttributeSelected(ProductModel product, String attributeName, String attributeValue) {
    ...
    final selectedVariation = product.productVariants!.firstWhere(
      (variation) => _isSameAttributeValues(variation.attributes, selectedAttributes),
      orElse: () => ProductVariationModel.empty(),
    );

    if (selectedVariation.image != null && selectedVariation.image!.isNotEmpty) {
  ...
  bool _isSameAttributeValues(Map<String, String> variationAttributes, Map<String, String> selectedAttributes) {
